...
function ts_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		...
		<div class="comment-meta commentmetadata"><span class="time"><a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>">
			<?php
...
print '<ul id="topnav"><li class="'.$class.'"><a href=" '.get_option('home') .' " title=" '.__('Click for Home','templatesquare').' ">'.__('Home','templatesquare').'</a></li>';
