...
$options = array (
				...
				array(	"name" => __('Body Links', 'templatesquare'),
											"desc" => '',
											"id" => $shortname."_linkcolor",
											"std" => "#fe872a",
											"type" => "colorpicker"),
											
				array(	"name" => __('Body Hover Links', 'templatesquare'),
											"desc" => '',
											"id" => $shortname."_linkhover",
											"std" => "#f48b38",
											"type" => "colorpicker"),
											
				array(	"name" => __('Top Navi Links', 'templatesquare'),
											"desc" => '',
											"id" => $shortname."_topnavcolor",
											"std" => "#212121",
											"type" => "colorpicker"),
											
				array(	"name" => __('Top Navi Links Active/Hover', 'templatesquare'),
											"desc" => '',
											"id" => $shortname."_topnavcoloractive",
											"std" => "#fe872a",
											"type" => "colorpicker"),
											
											
											
				array(	"name" => __('Button Background Color', 'templatesquare'),
											"desc" => '',
											"id" => $shortname."_buttonbgcolor",
											"std" => "#fe872a",
											"type" => "colorpicker"),
											
											
				array(	"name" => __('Button Hover Background Color', 'templatesquare'),
											"desc" => '',
											"id" => $shortname."_buttonbgcolorhover",
											"std" => "#ef9651",
											"type" => "colorpicker"),
											
											
				array(	"name" => __('Button Text Color', 'templatesquare'),
											"desc" => '',
											"id" => $shortname."_buttontextcolor",
											"std" => "#fff",
											"type" => "colorpicker"),
											
											
				array(	"name" => __('Background Color', 'templatesquare'),
											"desc" => '',
				...
				array(	"name" => __('Background Image Url', 'templatesquare'),
											"desc" =>__('Enter the background image url (http://www.fullurl.com/background.png).', 'templatesquare'),
											"id" => $shortname."_bgimage",
											"std" => "",
											"type" => "text"),
											
				array(	"name" => __('Disable Background Image', 'templatesquare'),
											"desc" => __('Select this checkbox to remove background image.', 'templatesquare'),
											"id" => $shortname."_disable_bgimage",
											"std" => "",
											"type" => "checkbox"),
				...
				array( 	"name" => __('Slider Timeout', 'templatesquare'),
											"desc" => __('Please enter number for slider timeout(transition time). Default is 8000', 'templatesquare'),
