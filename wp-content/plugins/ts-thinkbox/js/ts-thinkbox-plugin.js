		...
		createControl : function(id, controlManager) {
			if (id == 'ts_thinkbox_button') {
				...
				var button = controlManager.createButton('ts_thinkbox_button', {
					...
					image : '../wp-content/plugins/ts-thinkbox/images/icon-mce-plugin.png',  // path to the button's image
					onclick : function() {
		...
		createControl : function(id, controlManager) {
			if (id == 'ts_thinkbox_slider_button') {
				...
				var button = controlManager.createButton('ts_thinkbox_slider_button', {
					...
					image : '../wp-content/plugins/ts-thinkbox/images/icon-mce-plugin2.png',  // path to the button's image
					onclick : function() {
						// triggers the thickbox
						var width = jQuery(window).width(), H = jQuery(window).height(), W = ( 720 < width ) ? 720 : width;
						W = W - 80;
